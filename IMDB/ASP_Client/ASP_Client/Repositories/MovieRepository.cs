...
namespace ASP_Client.Repositories
{
    ...
    public class MovieRepository : IMovieRepository
    {
        ...
        {
            return Storage.Storage.GetMoviesAsync(searchString);
        }
        ...
        {
            return Storage.Storage.GetMovieDetailsLocallyAsync(movieId);
        }
        ...
        {
            return Storage.Storage.RateMovie(review);
        }
        ...
        {
            return Storage.Storage.GetMovieDetailsAsyncForce(movieId);
        }
    }
}